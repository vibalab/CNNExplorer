...
# Function to load the pretrained model based on its name and numbering
def load_pretrained_model(model_name, numbering):
    ...
    for layer in model.children():
        if isinstance(layer, nn.Module):  # Check if the layer is a module (e.g., not a functional operation)
...
test_dataset = datasets.ImageFolder(root='test_image', transform=data_transforms)
